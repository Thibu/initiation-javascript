...
let urlImage;
    ...
    function difficulté() {
        ...
        switch (level) {
            case 5:
                console.log('la diff est 5')
                newGame(5);
                break;
            case 6:
                console.log('la diff est 6')
                newGame(6);
                break;
            case 7:
                console.log('la diff est 7')
                newGame(7);
                break;
            case 8:
                console.log('la diff est 8')
                newGame(8);
                break;
            case 9:
                console.log('la diff est 9')
                newGame(9);
                break;
            case 10:
                console.log('la diff est 10')
                newGame(10);
                break;
        }
    ...
    function refresh(){
        ...
        <div class='containerJeu'>
            <div>
                ...
                <h3>${tableauLettre.join(" ")}</h3>
            </div>
            <div>
                <img src='${urlImage}' alt='url image' />
                <p>Essais restant : ${score}</p>
            </div>
        </div>`;
    ...
    function choisirLettre(){
        ...
        //boucle do while
        do {
            lettreJoueur = prompt(`Il vous reste ${score} essais. \nChoisissez une lettre`)
    ...
    function checkTableau() {
        ...
        if (score == 0) {
            ...
            confirm(`Voulez-vous rejouer ?`) ? difficulté() : alert(`Au Revoir`)
        }else{
            reponse = 0;
